...
use Closure;
use Generator;
use Morpho\Tool\Php\ClassTypeReflection;
use Morpho\Tool\Php\FileReflection;
use Morpho\Tool\Php\NamespaceReflection;
        ...
        foreach ($rFile->namespaces() as $rNamespace) {
            ...
            $this->checkClassTypes(
                [
                    ...
                    'Morpho_Test_Unit_Tool_Php_FileReflectionTest_MyIface',
                    'Morpho_Test_Unit_Tool_Php_FileReflectionTest_MyEnum',
                ],
                $filePath,
                $rNamespace
            );
